...
def result(request):
    ...
    if found_apt:
        ...
        text1="Here are some examples of other properties that may interest you in:"
        city_name=new_form[4]
        return render(request,'result.html',{'text':text,'city':city,'text1':text1,'city_name':city_name})
